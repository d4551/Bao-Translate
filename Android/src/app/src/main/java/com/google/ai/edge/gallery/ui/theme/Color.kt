...
// Gemini branded gradient (used in prompt templates)
val geminiGradientBlue = Color(0xFF4285f4)
val geminiGradientPurple = Color(0xFF9b72cb)
val geminiGradientCoral = Color(0xFFd96570)
