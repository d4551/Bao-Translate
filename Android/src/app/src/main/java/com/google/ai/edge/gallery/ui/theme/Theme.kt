...
data class CustomColors(
  ...
  val userBubbleContentColor: Color = Color.White,
  val userBubbleSecondaryContentColor: Color = Color.White,
  val userBubbleTertiaryContentColor: Color = Color.White,
...
val lightCustomColors =
  CustomColors(
    ...
    userBubbleContentColor = Color.White,
    userBubbleSecondaryContentColor = Color.White.copy(alpha = 0.88f),
    userBubbleTertiaryContentColor = Color.White.copy(alpha = 0.78f),
...
val darkCustomColors =
  CustomColors(
    ...
    userBubbleContentColor = onPrimaryContainerDark,
    userBubbleSecondaryContentColor = onPrimaryContainerDark.copy(alpha = 0.88f),
    userBubbleTertiaryContentColor = onPrimaryContainerDark.copy(alpha = 0.78f),
...
/** Composition local for the system animator duration scale. 0f means reduced motion. */
val LocalAnimationScale = staticCompositionLocalOf { 1f }

/** Returns whether reduced motion is enabled based on system animator duration scale. */
val isReducedMotion: Boolean
  @Composable @ReadOnlyComposable get() = LocalAnimationScale.current == 0f
...
fun StatusBarColorController(useDarkTheme: Boolean) {
  ...
  if (currentWindow != null && !view.isInEditMode) {
