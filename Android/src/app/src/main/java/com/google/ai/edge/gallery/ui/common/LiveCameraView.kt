...
private const val TAG = "LiveCameraView"
...
fun LiveCameraView(
  ...
  // Single shared executor for image analysis; shut down on dispose so we don't leak a thread
  // per camera bind (a fresh executor was previously created inside setAnalyzer on every start).
