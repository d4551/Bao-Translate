...
data class Task(
  ...
  /**
   * Optional string resource id for the label. When set, [com.google.ai.edge.gallery.ui.common.taskLabelText]
   * will resolve it via [stringResource] for the active configuration. Falls back to [label] when null.
   * This is the preferred way to add i18n-able built-in task labels.
   */
