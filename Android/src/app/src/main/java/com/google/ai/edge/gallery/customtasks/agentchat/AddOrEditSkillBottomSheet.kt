...
private fun ScriptsTabContent(
  ...
  if (showDeleteConfirmation) {
    AlertDialog(
      ...
      text = {
        Text(stringResource(R.string.delete_script_dialog_content, selectedScript ?: ""))
      },
      confirmButton = {
        Button(
          onClick = {
