  ...
  ModalBottomSheet(onDismissRequest = onDismiss, sheetState = sheetState) {
    Column(modifier = Modifier.fillMaxWidth().padding(16.dp)) {
      ...
      OutlinedTextField(
        ...
        label = { Text(stringResource(R.string.skill_tester_input_data)) },
      ...
      OutlinedTextField(
        ...
        label = { Text(stringResource(R.string.skill_tester_custom_data)) },
      ...
      val tabs =
        listOf(
          stringResource(R.string.skill_tester_tab_result),
          stringResource(R.string.skill_tester_tab_logs),
        )
      ...
      Button(
        onClick = {
          ...
          scope.launch(Dispatchers.Default) {
            ...
            outcome.onFailure { e -> error = e.message ?: "Unknown error" }
            running = false
          }
        },
