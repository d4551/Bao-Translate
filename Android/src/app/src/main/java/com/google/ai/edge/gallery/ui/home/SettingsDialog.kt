    ...
    Card(
      ...
      Column(
        ...
        Column {
          ...
          // Subtitle.
          Text(
            stringResource(R.string.settings_app_version, ProjectConfig.versionName, ProjectConfig.versionCode),
        ...
        Column(
          ...
          Column(
            ...
            if (curHfToken != null && curHfToken.accessToken.isNotEmpty()) {
              ...
              Text(
                stringResource(R.string.settings_hf_token_expires, dateFormatter.format(Instant.ofEpochMilli(curHfToken.expiresAtMs))),
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
              )
            } else {
