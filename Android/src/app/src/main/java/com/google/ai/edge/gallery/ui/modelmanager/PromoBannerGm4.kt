...
fun PromoBannerGm4(onDismiss: () -> Unit, modifier: Modifier = Modifier) {
  ...
  Box(modifier = modifier) {
    ...
    Column(
      ...
      Text(text = stringResource(R.string.promo_banner_gm4_title), style = MaterialTheme.typography.titleMedium)
      Text(
        stringResource(R.string.promo_banner_gm4_description),
